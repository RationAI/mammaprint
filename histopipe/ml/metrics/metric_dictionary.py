...
class MetricDictionary(torch.nn.ModuleDict):
    ...
    def update(self, stage: str, y_pred, y_true, dataloader_idx=None) -> None:
        dataloader_idx = MetricDictionary._sanitize_dataloader_idx(dataloader_idx)
    ...
    @staticmethod
    def _sanitize_dataloader_idx(dataloader_idx: str | None) -> str:
        if dataloader_idx:
            dataloader_idx = dataloader_idx.replace(".", "_")
