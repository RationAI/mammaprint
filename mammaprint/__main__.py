...
from mammaprint.mammaprint_model import MammaprintModel
from mammaprint.data import DataModule
...
def main(config: DictConfig, logger: Logger | None) -> None:
    ...
    model = hydra.utils.instantiate(config.model, _target_=MammaprintModel)
