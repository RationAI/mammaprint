...
class GatedAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        A = torch.tanh(A_V) * self.sigmoid(
            A_U
        )  # Shape: [batch_size * num_tiles, attention_dim]
...
class AttMILModel(nn.Module):
    ...
    def forward(self, x):
        ...
        x_flat = x.view(
            batch_size * num_tiles, features
        )  # Shape: [batch_size * num_tiles, features]
        ...
        weights = attention_weights.view(
